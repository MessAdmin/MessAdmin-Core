...
package clime.messadmin.utils.backport.java.util.concurrent;
    ...
    public boolean offerFirst(E e, long timeout, TimeUnit unit)
        ...
        try {
            for (;;) {
                ...
                if (nanos <= 0)
                    return false;
                notFull.await(nanos, java.util.concurrent.TimeUnit.NANOSECONDS);
    ...
    public E pollFirst(long timeout, TimeUnit unit)
        ...
        try {
            for (;;) {
                ...
                if (nanos <= 0)
                    return null;
                notEmpty.await(nanos, java.util.concurrent.TimeUnit.NANOSECONDS);
                nanos = deadline - System.nanoTime();
            }
        } finally {
            lock.unlock();

...
public class Config {
	...
	= "javax.servlet.jsp.jstl.sql.dataSource";//$NON-NLS-1$
	...
	= "javax.servlet.jsp.jstl.sql.maxRows";//$NON-NLS-1$
	
    /*
     * Private constants
     */
    private static final String PAGE_SCOPE_SUFFIX = ".page";//$NON-NLS-1$

...
package clime.messadmin.taglib.jstl.fmt;
...
public class LocaleSupport {
	...
	String message = MessageTag.UNDEFINED_KEY + key
	    + MessageTag.UNDEFINED_KEY;

	if (basename != null) {
	    locCtxt = BundleTag.getLocalizationContext(pageContext, basename);
	} else {

...
public abstract class ParamSupport extends BodyTagSupport {
    ...
    public int doEndTag() throws JspException {
        ...
        if (t == null) {
            throw new JspTagException("&lt;param&gt; outside &lt;import&gt; or &lt;urlEncode&gt;");//$NON-NLS-1$
        }
        ...
        if (encode) {
            ...
            try {
            	...
            	jte.initCause(e);
                throw jte;//FIXME JSP 2.0: throw new JspTagException(e);
            }
        } else {
    ...
    public static class ParamManager {
        ...
        public String aggregateParams(String url) {
            ...
            for (int i = 0; i < names.size(); ++i) {
                newParams.append(names.get(i) + "=" + values.get(i));//$NON-NLS-1$
                if (i < (names.size() - 1)) {
                    newParams.append('&');
                }
            }
